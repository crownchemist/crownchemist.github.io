...
addServiceButtonContainer.classList.add("hidden");
timeField.value = ""
if (this.value) {
...
addServiceButtonContainer.classList.remove("hidden");
// Show contact fields
...
serviceCard.classList.add("additional-service-card");
serviceCard.id = `additional-service-${additionalServiceCount}`;
serviceCard.innerHTML = `
<div class="additional-service-header">
<span class="additional-service-label">Additional Service ${additionalServiceCount}</span>
<button type="button" class="remove-service-btn" onclick="removeAdditionalService(${additionalServiceCount})">✕ Remove</button>
</div>
<select name="additional_service_${additionalServiceCount}" class="additional-service-select" required>
